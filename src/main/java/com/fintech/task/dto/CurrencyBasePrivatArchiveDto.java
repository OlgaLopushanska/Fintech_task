...
public class CurrencyBasePrivatArchiveDto {
    private Long id;
    ...
    public CurrencyBasePrivatArchiveDto(Long id, String baseCurrency, String currency, double saleRateNB,
    ...
    public CurrencyBasePrivatArchiveDto() {}
